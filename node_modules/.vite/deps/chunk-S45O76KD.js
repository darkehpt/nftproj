...
var ICONS = {
  add: async () => (await import("./add-PNTRHWYO.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-DZCELCXR.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-LN7WNWK6.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-5WULAUL3.js")).appStoreSvg,
  apple: async () => (await import("./apple-MT7VTRLY.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-WS72SKIQ.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-EDWBHT52.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-NQDVMZBO.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-7J63L7HH.js")).arrowTopSvg,
  bank: async () => (await import("./bank-OQL7URBP.js")).bankSvg,
  browser: async () => (await import("./browser-MUOSFXJR.js")).browserSvg,
  card: async () => (await import("./card-I5BGZPTM.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-KVHQPAAA.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-JZBPAUAS.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-WAWPTC7I.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-ITW6BBPS.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-JBJRTHUN.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-ICXADXRI.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-W3MNEQQ2.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-ND7NERAC.js")).clockSvg,
  close: async () => (await import("./close-5NBF46L4.js")).closeSvg,
  compass: async () => (await import("./compass-LOU6VHNF.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-UEJH3RH4.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-4HO3D4WW.js")).copySvg,
  cursor: async () => (await import("./cursor-TQBO5SEK.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-TSQQCIAG.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-A5U5444C.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-E2UJY4YC.js")).disconnectSvg,
  discord: async () => (await import("./discord-EJ655KJ3.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-K75CXGY2.js")).etherscanSvg,
  extension: async () => (await import("./extension-WMP4TYKM.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-H6EEKDAE.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-2XLR3R2P.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-4IPJH5DS.js")).farcasterSvg,
  filters: async () => (await import("./filters-JWFS2SRN.js")).filtersSvg,
  github: async () => (await import("./github-QCKBFQO6.js")).githubSvg,
  google: async () => (await import("./google-WRWGCE3T.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-HWCPP3NK.js")).helpCircleSvg,
  image: async () => (await import("./image-D732KW6R.js")).imageSvg,
  id: async () => (await import("./id-J66PW327.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-CY6ZNFXD.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-VVGLGLIF.js")).lightbulbSvg,
  mail: async () => (await import("./mail-KKU67A6S.js")).mailSvg,
  mobile: async () => (await import("./mobile-2FE74P7N.js")).mobileSvg,
  more: async () => (await import("./more-LYOMQVKD.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-YHGJMDCY.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-VXTPBFJW.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-EIHPZ47T.js")).offSvg,
  playStore: async () => (await import("./play-store-3UZOUFGY.js")).playStoreSvg,
  plus: async () => (await import("./plus-FMUJ3J4X.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-3EGUN27E.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-BNDY6PH6.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-RHEIIAVG.js")).refreshSvg,
  search: async () => (await import("./search-XEFDERFA.js")).searchSvg,
  send: async () => (await import("./send-CR5TMGJH.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-TLADSKJQ.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-6J64HVO6.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-T7YHOR4H.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-VYWLV5NZ.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-6SVOY5EE.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-ZWNKZFTJ.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-XRW3RCLV.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-RLB7NKLP.js")).twitchSvg,
  twitter: async () => (await import("./x-ZKKJM62D.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-KJFVO2MX.js")).twitterIconSvg,
  verify: async () => (await import("./verify-AGLMORGC.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-3KV4QX2T.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-HVRWEA6D.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-6KDGLQAS.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-6KDGLQAS.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-6KDGLQAS.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-TULZNSRG.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-SCLS5423.js")).warningCircleSvg,
  x: async () => (await import("./x-ZKKJM62D.js")).xSvg,
  info: async () => (await import("./info-VZPRX5TT.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-KV7KQY3W.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-VJSPGET7.js")).reownSvg
};
...
lit-html/development/directive-helpers.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-S45O76KD.js.map
